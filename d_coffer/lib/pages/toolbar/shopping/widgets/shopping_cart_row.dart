...
import 'package:d_coffer/components/a_checkbox/a_checkbox.dart';
import 'package:d_coffer/components/a_row/a_row.dart';
import 'package:d_coffer/components/a_stepper/a_stepper.dart';
          ...
          Expanded(
            child: Container(
              child: Column(
                ...
                Row(children: <Widget>[
                  Text('${Global.handleGoodsDesc(data.specName)}', style: TextStyle(
