...
import 'package:d_coffer/pages/order/widgets/goods_msg_row.dart';
...
class _OrderConfirmState extends State<OrderConfirm> {
  double bottom = Global.screenPadding().bottom; // 获取屏幕的底部距离
                            ...
                            children: <Widget>[
                              ...
                              Column(
                                children: _orderData.keys.map((key) {
                                  return GoodsMsgRow(data: _shoppingCartModel.data[key],);
                                }).toList()
                              )
                            ],
                          ),
                            ...
                            children: <Widget>[
                              Row(children: <Widget>[
                                ...
                                Container(
                                  ...
                                  child: Text('¥ ${_shoppingCartModel.totalPrice}', style: TextStyle(
                                    color: rgba(56, 56, 56, 1),
                                    fontWeight: FontWeight.bold,
                                    fontSize: 16
                                  ),),
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    ...
                    AButton.normal(
                      ...
                      onPressed: () => Global.pushNamed('/order_detail', arguments: {
                        "status": 1
                      })
                    )
                  ],
